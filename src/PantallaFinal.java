...
public class PantallaFinal extends JFrame {
	...
	public static void main(String[] args) {
		try {
			PantallaFinal dialog = new PantallaFinal(name, puntos);
	...
	public PantallaFinal(String name, int puntos) {
		...
		}
		{
			...
			lblNewLabel_1.setIcon(new ImageIcon(PantallaFinal.class.getResource("/imagenes/gameover.png")));
		...
		
		{
			...
			okButton.setIcon(new ImageIcon(PantallaFinal.class.getResource("/imagenes/go.png")));
		...
		}
		{
			...
			cancelButton.setIcon(new ImageIcon(PantallaFinal.class.getResource("/imagenes/cancel.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(PantallaFinal.class.getResource("/imagenes/giphy.gif")));
